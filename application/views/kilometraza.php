...
<?php $this->load->view('header/header');?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class='active'><a href="<?php echo base_url()?>bxmtime/kilometraza"><i class="fa fa-dashboard"></i> <span>Kilometraza</span></a></li>         
  ...
  <div class="box-header with-border">
    <h3 class="box-title">Dodavanje kilometraze</h3>
    ...
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <div class="box box-solid box-primary">
          <div class="box-header with-border">
            <h3 class="box-title">Dodaj kilometrazu</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo form_open('', 'class="form-horizontal" id="kilometraza"'); ?>
...
var table;
  ...
  $(document).ajaxStart(function() { Pace.restart(); });
    $('.ajax').click(function(){
      Pace.track(function() {
        $.ajax({
            url: '<?php echo base_url(); ?>bxmtime/addkms',
            method: "post",
            data: $('#kilometraza').serialize(),
            dataType: 'json',
            beforeSend: function() {
              $('#successalert').remove();
            ...
            success: function(result){        
              if ($('#successalert').length == 0) {
                $("#kms").dataTable().fnDestroy();
                $('#inputform').prepend(result.message);
                $('#kms').html(result.table);
                reinitializeTable();
