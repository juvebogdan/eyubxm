...
<?php $this->load->view('header/header');?>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?php echo base_url()?>directors/"><i class="fa fa-users"></i> <span>Overview</span></a></li>      
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-header">
              ...
              <a class="btn btn-success btn-sm exportdata pull-right" href="<?php echo base_url();?>directors/export"><span class="glyphicon glyphicon-download-alt"></span> Export to Excel</a>
        </div>
        <div class="box-body">
