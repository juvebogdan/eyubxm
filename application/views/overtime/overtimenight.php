...
<?php $this->load->view('header/header'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('Overtime Night') ?>
        <small><?php echo $this->lang->line('Submit nightly overtime work') ?></small>
      </h1>
    </section>
      ...
      <div class="col-md-8 col-md-offset-2">
        <div class="box box-solid box-primary">
          <div class="box-header with-border">
            <h3 class="box-title"><?php echo $this->lang->line('Overtime Night') ?></h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
            ...
            <div class="box-body" id="inputform">
              ...
              <div class="row">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="description" rows="3" placeholder="<?php echo $this->lang->line('Short description optional') ?>"></textarea>
                </div>              
              </div>              
            </div>
            <!-- /.box-body -->
...
var table;
  ...
  $(document).ajaxStart(function() { Pace.restart(); });
    $('.ajax').click(function(){
      Pace.track(function() {
        $.ajax({
            url: '<?php echo base_url(); ?>bxmtime/addovertime/overtimenight',
            method: "post",
